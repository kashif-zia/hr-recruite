...
export default function CompanyProfileCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setEstablished(initialValues.established);
    setCapital(initialValues.capital);
    setAddress(initialValues.address);
    setNoOfEmployees(initialValues.noOfEmployees);
    setCompanyOverview(initialValues.companyOverview);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new CompanyProfile(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "CompanyProfileCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
