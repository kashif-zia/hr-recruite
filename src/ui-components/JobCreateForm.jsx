...
export default function JobCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setJobGroup(initialValues.jobGroup);
    setJobLayer(initialValues.jobLayer);
    setJobDepartment(initialValues.jobDepartment);
    setJobCoverImage(initialValues.jobCoverImage);
    setJobDescription(initialValues.jobDescription);
    setKeyResponsibilities(initialValues.keyResponsibilities);
    setRequirements(initialValues.requirements);
    setDistinctiveFeaturesOfTheRole(initialValues.distinctiveFeaturesOfTheRole);
    setExpectedSalary(initialValues.expectedSalary);
    setWorkingHours(initialValues.workingHours);
    setBenefits(initialValues.benefits);
    setApplicationProcess(initialValues.applicationProcess);
    setEqualOpportunityStatement(initialValues.equalOpportunityStatement);
    setProbationPeriod(initialValues.probationPeriod);
